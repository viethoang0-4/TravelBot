...
REFUSAL_MSG = (
    "Mình là **TravelBot** — trợ lý chuyên về du lịch, nên mình chỉ hỗ trợ các chủ đề liên quan đến "
...
SUPERVISOR_PROMPT = """Bạn là **Supervisor** của hệ thống trợ lý du lịch TravelBot.
...
CLARIFY_PROMPT = """Bạn là **TravelBot**. Người dùng muốn lập lịch trình nhưng còn THIẾU vài thông tin
...
PRESENTER_PROMPT = """Bạn là **TravelBot** đang trình bày lịch trình đã hoàn thiện cho người dùng.
